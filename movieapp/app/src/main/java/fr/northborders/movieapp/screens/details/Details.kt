package fr.northborders.movieapp.screens.details
    ...
    Scaffold(topBar = {
        TopAppBar(
            ...
            Row(horizontalArrangement = Arrangement.Start) {
                ...
                Text(text = movieList.first().title, style = MaterialTheme.typography.h6)
            }
        }
    }) {
        Surface(
            ...
            Column(
                ...
                MovieRow(movie = movieList.first(), onItemClick = {})
    ...
    LazyRow {
        items(movieList.first().images) {
            Card(
                ...
                Image(painter = rememberImagePainter(data = it), contentDescription = "Movie Image")
            }
        }
    }
}